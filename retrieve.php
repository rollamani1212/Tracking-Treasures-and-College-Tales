...
<div class="buttons">
    <a href="http://localhost/project/lost.php" target="_self" class="btn">Lost Items</a>
    <a href="http://localhost/project/found.php" target="_self" class="btn" style="margin-left: 10px;">Found Items</a>
</div>
